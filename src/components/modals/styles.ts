...
export const successBtn =
  "flex-1 rounded-md border-none bg-success p-[13px] text-sm font-bold text-white";

export const dangerBtn =
  "flex-1 rounded-md border-none bg-danger p-[13px] text-sm font-bold text-white";
