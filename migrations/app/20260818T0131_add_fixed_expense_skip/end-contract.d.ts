...
export type StorageHash =
  StorageHashBase<'sha256:eebb86769173a119fac39cd9aa2e04d31cd27fd61c855bc654c007040effb810'>;
export type ExecutionHash =
  ExecutionHashBase<'sha256:fd7aca6fa47486e7ac806d8a4c0c235feb8b5d27e251052d9e0a44308e38b1d7'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly FixedExpenseSkip: {
      readonly id: Char<36>;
      readonly userId: CodecTypes['pg/text@1']['output'];
      readonly fixedExpenseId: Char<36>;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly FixedExpenseSkip: {
      readonly id: CodecTypes['sql/char@1']['input'];
      readonly userId: CodecTypes['pg/text@1']['input'];
      readonly fixedExpenseId: CodecTypes['sql/char@1']['input'];
              ...
              indexes: readonly [
                {
                  ...
                  readonly name: 'FixedExpenseSkip_fixedExpenseId_idx';
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    ...
                    readonly tableName: 'FixedExpenseSkip';
                    readonly columns: readonly ['fixedExpenseId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
...
> & {
  ...
  readonly roots: {
    ...
    readonly FixedExpenseSkip: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'FixedExpenseSkip';
    };
    readonly Transaction: {
      readonly namespace: 'public' & NamespaceId;
      ...
      readonly public: {
        readonly models: {
          ...
          readonly FixedExpenseSkip: {
            ...
            readonly storage: {
              readonly table: 'FixedExpenseSkip';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userId: { readonly column: 'userId' };
